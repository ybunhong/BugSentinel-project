...
export const ConnectionStatus: React.FC = () => {
  ...
  const getStatusText = () => {
    ...
    if (connectionStatus.pendingChanges > 0)
      return `${connectionStatus.pendingChanges} pending`;
    return "Synced";
  };
          ...
          >
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <span
                style={{
                  color:
                    connectionStatus.pendingChanges > 0 ? "#ffc107" : "#28a745",
                }}
              >
              ...
              connectionStatus.pendingChanges > 0 && (
                <button
                  ...
                  style={{
                    ...
                    border: "none",
                    borderRadius: "6px",
                    cursor: connectionStatus.syncInProgress
                      ? "not-allowed"
                      : "pointer",
