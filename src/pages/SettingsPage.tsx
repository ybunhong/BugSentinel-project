...
export const SettingsPage: React.FC = () => {
  ...
  const handleLogout = async () => {
    const confirmLogout = confirm('Are you sure you want to log out? Any unsaved changes will be lost.');
            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  ...
                  color: theme === 'light' ? '#ffffff' : (theme === 'dark' ? '#cccccc' : '#666666'),
                  border: theme === 'light' 
                    ? 'none'
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div>
            ...
            <p style={{
              ...
              Clear all locally cached data including snippets and settings. Your cloud data will remain safe.
            </p>
